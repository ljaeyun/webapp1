...
<div class="menu">
	<ul>
		<li class="chapter">Ch00. <a href="<%=application.getContextPath()%>/ch00/content">Development Environment</a></li>
		...
		<li class="chapter">Ch03. <a href="<%=application.getContextPath()%>/ch03/content">Controller - Request Parameter</a></li>
		...
		<li class="chapter">Ch13. <a href="<%=application.getContextPath()%>/ch13/content">Want to go outside and get yourself cold?</a></li>
